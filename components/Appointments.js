export default function Appointments({ activeSubTab, onChangeTab }) {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border">
        ...
        <div className="p-6">
          <p className="text-gray-500">Content for <strong>{activeSubTab}</strong> appointments will go here.</p>
        </div>
      </div>
    </div>
  );
