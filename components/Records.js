  ...
  const recordList = [
    {
      ...
      file: '/records/blood-test.pdf'
    },
    {
      title: 'Chest X-Ray',
      file: '/records/chest-xray.pdf'
    },
    {
      title: 'Prescription - Antibiotics',
      file: '/records/prescription.pdf'
    }
  ];
          ...
          <div key={idx} className="bg-white border border-gray-200 rounded-lg p-6 flex justify-between items-center">
            ...
            <div className="flex space-x-2">
              <a
                ...
                className="border border-gray-300 text-gray-700 hover:bg-gray-50 px-3 py-2 rounded-md text-sm"
              >
                View
              </a>
              <a
                href={record.file}
                download
                className="border border-gray-300 text-gray-700 hover:bg-gray-50 px-3 py-2 rounded-md text-sm flex items-center"
              >
